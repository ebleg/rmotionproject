function [coll_node]=LineInObstacletest(point2,nodes_near2,shapes2)
n=1000;  %number of points on line
...
coll_node_1=zeros(1,s2);
        tf = inShape(shapes2,xx,yy,zz); %check if line of node collides with one of the shapes
